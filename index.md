...
or prebuilt from the [SportsDataverse
r-universe](https://sportsdataverse.r-universe.dev) with:
...
- [**`baseballr`**](https://baseballr.sportsdataverse.org/), for MLB and
...
[![Version-Number](https://img.shields.io/github/r-package/v/sportsdataverse/baseballr?label=baseballr&logo=R&style=for-the-badge)](https://github.com/sportsdataverse/baseballr)
[![R-CMD-check](https://img.shields.io/github/actions/workflow/status/sportsdataverse/baseballr/R-CMD-check.yaml?branch=main&label=R-CMD-Check&logo=R&logoColor=white&style=for-the-badge)](https://github.com/sportsdataverse/baseballr/actions/workflows/R-CMD-check.yaml)
[![CRAN
